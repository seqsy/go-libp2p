...
This patch release fixes a busy-looping happening inside AutoRelay on private nodes, see [2208](https://github.com/seqsy/go-libp2p/pull/2208).
...
#### [Removed Circuit Relay v1](https://github.com/seqsy/go-libp2p/pull/2107) <!-- omit in toc -->
...
#### [Unlimited Relay v2](https://github.com/seqsy/go-libp2p/pull/2125) <!-- omit in toc -->
...
### [Stop sending detailed error messages on closing QUIC connections](https://github.com/seqsy/go-libp2p/pull/2112) <!-- omit in toc -->
