...
Our roadmap for go-libp2p can be found here: https://github.com/seqsy/go-libp2p/blob/master/ROADMAP.md
...
- ask questions or talk about things in  our [discussion forums](https://discuss.libp2p.io), or open an [issue](https://github.com/seqsy/go-libp2p/issues) for bug reports, or #libp2p on freenode.
